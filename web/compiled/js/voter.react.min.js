            ...
            dataTable: {
                ...
                "ajax": {
                    ...
                    "data": function (d) {
                        ...
                        d.hasId = $('#voter_table select[name="has_id"]').val();
                        d.hasPhoto = $('#voter_table select[name="has_photo"]').val();
            ...
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "row", id: "voter_component"}, 
                    React.createElement("div", {className: "col-md-5"}, 
                        ...
                        React.createElement("button", {className: "btn btn-primary btn-sm", style: { marginBottom: "10px"}, onClick: this.openNewVoterCreateModal}, React.createElement("i", {className: "fa fa-upload"}), " New Voter"), 
                        React.createElement("button", {className: "btn btn-success btn-sm", style: { marginBottom: "10px", marginLeft: "10px"}, onClick: this.openSmsModal}, "Text Blast"), 
                        false &&
                            (
                                React.createElement("div", null, 
                                    React.createElement("button", {className: "btn btn-primary btn-sm", style: { marginBottom: "10px"}, onClick: this.openUploadModal}, React.createElement("i", {className: "fa fa-upload"}), " Upload Record"), 
                                    React.createElement("button", {className: "btn btn-danger btn-sm", style: { marginBottom: "10px", marginLeft: "15px"}, onClick: this.openUploadVotingStatusModal}, React.createElement("i", {className: "fa fa-upload"}), " Update Record"), 
                                    React.createElement("button", {className: "btn btn-warning btn-sm", style: { marginBottom: "10px", marginLeft: "10px"}, onClick: this.openUploadBdayModal}, "Upload Birthday"), 
                                    React.createElement("button", {className: "btn btn-success btn-sm", style: { marginBottom: "10px", marginLeft: "10px"}, onClick: this.openSmsModal}, "Text Blast"), 
                                    React.createElement("button", {className: "btn btn-success btn-sm", style: { marginBottom: "10px", marginLeft: "10px"}, onClick: this.openJpmModal}, "Jpm List")
                                )
                            )
                    ...
                    React.createElement("table", {id: "voter_table", className: "table table-striped table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            ...
                            React.createElement("tr", null, 
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("select", {className: "form-control", name: "has_photo"}, 
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("select", {className: "form-control", name: "has_id"}, 
                                        React.createElement("option", {value: "-1"}, "ALL"), 
                                        React.createElement("option", {value: "1"}, "YES"), 
                                        React.createElement("option", {value: "0"}, "NO")
                                    )
