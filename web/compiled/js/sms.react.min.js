      ...
      React.createElement("div", {className: "portlet light bordered overflow-auto"}, 
        React.createElement("div", {className: "portlet-body"}, 
          React.createElement("div", {className: "col-md-12"}, 
            React.createElement("h3", {className: "h3 m-b-md"}, "SMS Section"), 

            
              isLoading ? 
              React.createElement("button", {type: "button", disabled: true, className: "demo-loading-btn btn btn-primary"}, " Please wait... Syncing sender... ") : 
              React.createElement("button", {type: "button", onClick: this.syncSender, className: "demo-loading-btn btn btn-primary"}, " Sync Sender")
