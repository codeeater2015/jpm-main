...
var RecruitmentDetailDatatable = React.createClass({displayName: "RecruitmentDetailDatatable",
...
var RecruitmentMemberCreateModal = React.createClass({displayName: "RecruitmentMemberCreateModal",
...
var RecruitmentMemberModal = React.createClass({displayName: "RecruitmentMemberModal",
    getInitialState: function () {
        return {
            member: null,
        ...
        return (
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, dialogClassName: "modal-custom-85", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                ...
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
                        ...
                        React.createElement(RecruitmentMemberCreateModal, {
                            proId: this.props.proId, 
                            provinceCode: 53, 
                    ...
                    React.createElement("div", {className: "row"}, 
                        React.createElement("div", {className: "col-md-6"}, 
                            React.createElement("strong", null, "Leader : "), " ", this.state.header.voterName, " ", React.createElement("br", null), 
                            React.createElement("strong", null, "Position : "), " ", this.state.header.voterGroup, " ", React.createElement("br", null), 
                            React.createElement("strong", null, "Elected Position : "), " ", this.state.header.position, " ", React.createElement("br", null), 
                        ...
                        React.createElement("div", {className: "col-md-2 col-md-offset-2"}, 
                            React.createElement(FormGroup, {controlId: "formDefaultDialect"}, 
                                React.createElement(ControlLabel, null, " Default Dialect : "), 
                                React.createElement("input", {type: "text", className: "input-sm form-control", value: defaults.dialect, onChange: this.setFormProp, name: "dialect"})
                            )
                        ), 
                        React.createElement("div", {className: "col-md-2"}, 
                            React.createElement(FormGroup, {controlId: "formDefaultDialect"}, 
                                React.createElement(ControlLabel, null, " Default Religion : "), 
                                React.createElement("input", {type: "text", className: "input-sm form-control", value: defaults.religion, onChange: this.setFormProp, name: "religion"})
                            )
                        )
                    ), 
                    React.createElement("br", null), 
                    ...
                    React.createElement("div", {className: "col-md-7", style: { paddingLeft: "0px", marginBottom: "10px"}}, 
                        ...
                        React.createElement(RecruitmentDetailDatatable, {ref: "DetailDatatable", 
                            municipalityNo: this.state.header.municipalityNo, 
                            municipalityName: this.state.header.municipalityName, 
                            barangayNo: this.state.header.barangayNo, 
                            barangayName: this.state.header.barangayName, 
...
var RecruitmentCreateModal = React.createClass({displayName: "RecruitmentCreateModal",
    ...
    render: function () {
        ...
        return (
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, bsSize: "lg", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                React.createElement(Modal.Header, {className: "modal-header bg-blue-dark font-white", closeButton: true}, 
                    React.createElement(Modal.Title, null, "Recruitment Form")
                ), 
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
...
var RecruitmentDatatable = React.createClass({displayName: "RecruitmentDatatable",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                    ...
                    React.createElement(RecruitmentCreateModal, {
                    ...
                    React.createElement(RecruitmentMemberModal, {
                    ...
                    React.createElement("table", {id: "recruitment_table", className: "table table-striped table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            React.createElement("tr", null, 
                                ...
                                React.createElement("th", {className: "text-center"}, "Total Recruits"), 
...
var RecruitmentComponent = React.createClass({displayName: "RecruitmentComponent",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                ...
                React.createElement(RecruitmentDatatable, null)
...
setTimeout(function () {
    ReactDOM.render(
        React.createElement(RecruitmentComponent, null),
